...
- Generate short, bulleted, classroom-ready Learning Experience activities directly aligned with the session Knowledge, Skills, and Attitude/Values objectives.
- Structure every Learning Experience with this learner-centered sequence: Engagement -> Exploration -> Discussion -> Application -> Generalization -> Assessment -> Reflection.
- Use clear action verbs, avoid repetition and lengthy descriptions, and keep every activity achievable within the class period.
