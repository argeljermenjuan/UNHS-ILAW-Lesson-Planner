...
- For every session, treat the day/session field as the FLOW section and write exactly four bullet points only.
- Each bullet must be one complete sentence in concise, teacher-friendly, classroom-ready language.
...
- Keep each sentence approximately 12-20 words long and avoid repetition, generic wording, headings, numbering, or extra explanation.
- Use clear action verbs and keep every activity achievable within the class period.
- Ensure activities show progression from participation and recall to collaboration, HOTS, application, assessment evidence, and reflection.
...
Skills: ...
Attitude/Values: ...
Write each day/session field as the FLOW section with exactly four bullet points only, one complete sentence per bullet.
The bullets must summarize the lesson sequence from introduction to assessment in this order: opening and prior knowledge, guided exploration or modeling, practice and application, and quick assessment with feedback.
Each bullet should be concise, teacher-friendly, classroom-ready, and approximately 12-20 words long.
Do not add headings, numbering, explanations, or extra text beyond the four bullets.
